...
$value = $_POST['field1'];
$value2 = $_POST['field2'];
$sql = "INSERT INTO tyh (activity, happylev)
VALUES ('$value', '$value2')";
...
.woahbar-down-arrow:hover {
  background-color:#625EBD; /* << set custom hover bar color here */
}
...
.close-notify
{
  ...
  height: 19px;
  text-decoration: none;
  background-color: #625EBD; /* << set custom bar color here */
  cursor:pointer;
}
...
<input type="submit" value="View Weekly Results" />
</form>
</div>
    </span>
